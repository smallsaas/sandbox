...
echo 'curl -sOL https://gitee.com/smallsaas/sandbox/raw/master/tag/web/run.yml'
curl -sOL https://gitee.com/smallsaas/sandbox/raw/master/tag/web/run.yml
echo 'curl -sOL https://gitee.com/smallsaas/sandbox/raw/master/tag/web/run.sh'
curl -sOL https://gitee.com/smallsaas/sandbox/raw/master/tag/web/run.sh
